        ...
        <section className="pt-4">
          {loading && (
            <div className="col-lg-12 col-sm-12">
              <Loading className={"d-flex justify-content-center"} width={50} />
            </div>
          )}
        </section>
        <section className="pt-4">
              ...
              <div className="col-lg-4 order-2 order-lg-1 mb-2">
                ...
                <div className="row pt-2">
                  <div className="col-6">
                    <button
                      name="min"
                      className="bg-white d-flex justify-content-center form-control rounded-3"
                      type="button"
                    >
                      <span className="small">Thấp nhất</span>
                    </button>
                  </div>
                  <div className="col-6">
                    <button
                      ...
                      type="button"
                    >
                      <span className="small">Cao nhất</span>
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-lg-6 form-check mb-1">
                    <input
                      ...
                      id="checkbox_1"
                    />
                    <label className="form-check-label" to="checkbox_1">
                      Returns Accepted
                    </label>
                  </div>
                  <div className="col-lg-6 form-check mb-1">
                    <input
                      ...
                      id="checkbox_2"
                    />
                    <label className="form-check-label" to="checkbox_2">
                      Returns Accepted
                    </label>
                  </div>
                </div>
                <div className="row">
                  <div className="col-lg-6 form-check mb-1">
                    <input
                      ...
                      id="checkbox_3"
                    />
                    <label className="form-check-label" to="checkbox_3">
                      Completed Items
                    </label>
                  </div>
                  <div className="col-lg-6 form-check mb-1">
                    <input
                      ...
                      id="checkbox_4"
                    />
                    <label className="form-check-label" to={"checkbox_4"}>
                      Sold Items
                    </label>
                  </div>
                </div>
                <div className="row">
                  <div className="col-lg-6 form-check mb-1">
                    <input
                      ...
                      id="checkbox_5"
                    />
                    <label className="form-check-label" to="checkbox_5">
                      Deals &amp; Savings
                    </label>
                  </div>
                  <div className="col-lg-6 form-check mb-1">
                    <input
                      ...
                      id="checkbox_6"
                    />
                    <label className="form-check-label" to="checkbox_6">
                      Authorized Seller
                    </label>
                  </div>
                </div>
                ...
                <div className="d-flex justify-content-evenly">
                  <div className="form-check mb-1">
                    <input
                      ...
                      id="radio_1"
                    />
                    <label className="form-check-label" to="radio_1">
                      Toàn bộ
                    </label>
                  </div>
                  <div className="form-check mb-1">
                    <input
                      ...
                      id="radio_2"
                    />
                    <label className="form-check-label" to="radio_2">
                      Bán chạy
                    </label>
                  </div>
                  <div className="form-check mb-1">
                    <input
                      ...
                      id="radio_3"
                    />
                    <label className="form-check-label" to="radio_3">
                      Đánh giá cao
                    </label>
                  </div>
                  <div className="form-check mb-1">
                    <input
                      ...
                      id="radio_4"
                    />
                    <label className="form-check-label" to="radio_4">
                      Giá thấp
                    </label>
                  </div>
                </div>
