                  ...
                  <thead className="bg-light">
                    <tr>
                      <th className="border-0 p-3" scope="col">
                        {" "}
                        <strong className="text-sm text-uppercase">STT</strong>
                      </th>
                      <th className="border-0 p-3" scope="col">
                        {" "}
                      ...
                      <th className="border-0 p-3" scope="col">
                        {" "}
                        <strong className="text-sm text-uppercase">Giá</strong>
                      </th>
                      <th className="border-0 p-3" scope="col">
                        {" "}
                        <strong className="text-sm text-uppercase">
                  ...
                  <div className="row align-items-center text-center">
                    <div className="col-md-6 mb-3 mb-md-0 text-md-start">
                      <Link
                        ...
                        to="/cua-hang"
                      >
                        <i className="fas fa-long-arrow-alt-left me-2"> </i>Tiếp
                        tục mua sắm
                      </Link>
                    </div>
              ...
              <div className="card border-0 rounded-0 p-lg-4 bg-light">
                <div className="card-body">
                  <h5 className="text-uppercase mb-4">
                    Sản phẩm <span>({carts?.length})</span>
                  </h5>
                        ...
                        <form action="#">
                          <div className="input-group mb-0">
                            <input
                              ...
                              type="text"
                              placeholder="Nhập coupon để được giảm giá "
                              onChange={() => {}}
                            />
                            <button
                            ...
                            >
                              {" "}
                              <i className="fas fa-gift me-2"></i>Sử dụng coupon
                            </button>
                          </div>
                        </form>
                      </li>
